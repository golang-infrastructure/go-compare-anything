...
func CompareE[T any](a, b T) (int, error) {

}

func GenComparatorFor[T any](value T) (Comparator[T], error) {
	reflectType := reflect.TypeOf(value)
	kind, err := GenComparatorFromKind(reflectType.Kind())
...
func GenComparatorFromKind[T any](kind reflect.Kind) (Comparator[T], error) {
	...
	case reflect.Invalid:
		return nil, ErrCanNotGenerateComparator
	case reflect.Bool:
	...
	case reflect.Complex128:
		...
		return nil, ErrCanNotGenerateComparator
	case reflect.Array:
		return Comparator[T](SliceComparator[T]()), nil
	case reflect.Chan:
	case reflect.Func:
	...
	case reflect.Struct:
		return Comparator[T](StructComparator()), nil
